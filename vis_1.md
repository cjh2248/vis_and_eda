...
![](vis_1_files/figure-gfm/unnamed-chunk-6-1.png)<!-- --> use facetting
real quick
...
![](vis_1_files/figure-gfm/unnamed-chunk-7-1.png)<!-- --> Let’s make a
somewhat more interesting scatterplot
